...
ACCOUNT_FORMS = {'signup': 'board.forms.CustomSignupForm'}  # ссылка на форму регистрации по коду
"""
решение задания по отправке кода регистрации вместо ссылки на подтверждение эл.адреса
https://disk.yandex.ru/i/gpTPbyyJZLEmCA
большое спасибо Олегу Афанасьеву за старания и подробное объяснение.
выдайте ему премию. он заслужил. а лучше каждый месяц.
Олег, открывай канал где нибудь на Рутубе. у тебя отлично получается объяснять.
"""
